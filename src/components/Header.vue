<template>
    <div>
        <!-- header -->
        <header>
            <div class="bg-blue-500 text-white text-center fixed inset-x-0 top-0 z-10">
                ...
                <div class="col-span-8">
                    <input type="text" @click="linkToSearch" v-model="search" @keyup="searchQuery" class="appearance-none w-full bg-blue-200 rounded-full h-7 shadow-md placeholder-white focus:outline-none focus:placeholder-gray-600 focus:bg-white focus-within:text-gray-600 p-5"
                    placeholder="Cari Event di Load Island">
                </div>
                </div>
            </div>
        </header>
