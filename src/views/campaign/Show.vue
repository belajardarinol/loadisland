    ...
    <div class="pb-20 pt-20">
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-3">
                ...
                <div class="mt-3">
                    <span class="font-bold">{{ donations.length }}</span> Event
                ...
                <div v-if="maxDate(campaign.max_date) == true">
                    <div class="mt-5">
                        <button
                            class="bg-yellow-500 py-3 rounded-md shadow-md text-xl w-full uppercase font-bold focus:outline-none opacity-50 cursor-not-allowed">Pendaftaran Ditutup!</button>
                    </div>
                </div>
                <div v-else>
                    <div class="mt-5">
                    ...
                    <div class="grid grid-cols-10 gap-4">
                        ...
                        <div class="col-span-9 mt-1">
                            ...
                            <div class="text-sm mt-2 text-gray-500">
                                Investasi Knowledge sebesar <span class="font-bold">Rp. {{ formatPrice(donation.amount) }}</span>
                            </div>
                        </div>
